...
class Rewards extends PluginBase implements Listener{
    public function onLoad(){
        $this->getLogger()->info(TextFormat::RED."Prepair to load...");
        $this->getLogger()->info(TextFormat::RED."Registering events...");
        $this->getServer()->getPluginManager()->registerEvents($this,$this);
        
        $this->getLogger()->info(TextFormat::YELLOW."Fetching your server information...");
        $sname = getServer()->getName();
        $this->getLogger()->info(TextFormat::GREEN."Your server name is $sname");
        $this->getLogger()->info(TextFormat::GREEN."Finishing loader...");
    }
    public function onEnable(){
        $this->getLogger()->info(TextFormat::GREEN."Successfully loading!");
        $this->getLogger()->notice(TextFormat::RED."NOTE: ",TextFormat::WHITE."This is an In-Dev version of Rewards (0.10), so it might have some bugs. If you found it, reply to me!");
    }   
